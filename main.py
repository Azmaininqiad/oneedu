...
MCQ_SUPABASE_URL = os.getenv('MCQ_SUPABASE_URL')
MCQ_SUPABASE_KEY = os.getenv('MCQ_SUPABASE_KEY')
...
class Config:
    def __init__(self):
        ...
        self.SUPABASE_URL = EVAL_SUPABASE_URL
        self.SUPABASE_KEY = EVAL_SUPABASE_KEY
        self.SUPABASE_BUCKET = MCQ_SUPABASE_BUCKET
        self.MCQ_SUPABASE_URL = MCQ_SUPABASE_URL
        self.MCQ_SUPABASE_KEY = MCQ_SUPABASE_KEY
        self.TAVUS_API_KEY = TAVUS_API_KEY
        self.TAVUS_BASE_URL = TAVUS_BASE_URL
